 ...
 * 
 * @author Sebastian Felix Schwarz <tako-id@takomat.com>
 */
class Tx_News2facebook_Domain_Model_OpenGraphTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_NewsIn2facebook_Domain_Model_OpenGraph
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_News2facebook_Domain_Model_OpenGraph();
	}
